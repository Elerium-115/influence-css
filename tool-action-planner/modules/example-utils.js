...
const exampleActionsTemplate = [
    ...
    [ACTION_TYPE.EXTRACT,       'Water',            'Extractor',        89,     'Warehouse',        777,    5 * HOUR,       false,  ACTION_STATE.ONGOING        ],
    [ACTION_TYPE.CONSTRUCT,     'Marketplace',      'Empty Lot',        1,      null,               null,   23 * HOUR,      false,  ACTION_STATE.ONGOING        ],
    [ACTION_TYPE.CONSTRUCT,     'Spaceport',        'Empty Lot',        2,      null,               null,   12 * HOUR,      false,  ACTION_STATE.ONGOING        ],
    // Done actions, defined in reverse b/c they are prepended, NOT appended
    [ACTION_TYPE.CONSTRUCT,     'Warehouse',        'Empty Lot',        777,    null,               null,   23 * HOUR,      false,  ACTION_STATE.DONE,      96  ], // done 4 days ago
    [ACTION_TYPE.TRANSFER,      'Core Samplers',    'Light Transport',  666,    'Warehouse',        777,    1 * HOUR,       false,  ACTION_STATE.DONE,      72  ], // done 3 days ago
    [ACTION_TYPE.CORE_SAMPLE,   'Water',            'Empty Lot',        89,     null,               null,   0,              false,  ACTION_STATE.DONE,      48  ], // done 2 days ago, NO runtime duration (only startup duration) for Core Sample
    [ACTION_TYPE.CONSTRUCT,     'Extractor',        'Empty Lot',        89,     null,               null,   23 * HOUR,      false,  ACTION_STATE.DONE,      24  ], // done 1 day ago
    [ACTION_TYPE.CORE_SAMPLE,   'Hydrogen',         'Empty Lot',        123,    null,               null,   0,              false,  ACTION_STATE.DONE,      18  ], // done 18 hours ago, NO runtime duration (only startup duration) for Core Sample
];
