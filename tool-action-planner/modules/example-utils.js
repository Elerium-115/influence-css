...
const exampleActionsTemplate = [
    // Queued actions
    [ACTION_TYPE.EXTRACT,       'Hydrogen',         'Extractor',        123,    'Warehouse',        777,    0,                  true                                ],
    [ACTION_TYPE.CORE_SAMPLE,   'Methane',          'Lot',              4567,   null,               null,   0,                  true                                ],
    [ACTION_TYPE.CONSTRUCT,     'Extractor',        'Lot',              4567,   null,               null                                                            ],
    [ACTION_TYPE.EXTRACT,       'Methane',          'Extractor',        4567,   'Warehouse',        777                                                             ],
    [ACTION_TYPE.DECONSTRUCT,   'Extractor',        'Extractor',        89,     'Warehouse',        777                                                             ],
    [ACTION_TYPE.TRANSFER,      '[multiple]',       'Warehouse',        777,    'Light Transport',  666                                                             ],
    // Ongoing actions
