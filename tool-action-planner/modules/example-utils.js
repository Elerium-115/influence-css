...
const exampleActionsTemplate = [
    ...
    [ACTION_TYPE.CORE_SAMPLE,   'Methane',          'Empty Lot',        4567,   null,               null,   4 * HOUR                                                ], // duration 4 hours
    [ACTION_TYPE.CONSTRUCT,     'Extractor',        'Empty Lot',        4567,   null,               null,   12 * HOUR                                               ], // duration 12 hours
    ...
    // Ongoing actions
    [ACTION_TYPE.CONSTRUCT,     'Extractor',        'Empty Lot',        123,    null,               null,   0,                  true,   ACTION_STATE.ONGOING        ],
    [ACTION_TYPE.EXTRACT,       'Water',            'Extractor',        89,     'Warehouse',        777,    5 * HOUR,           false,  ACTION_STATE.ONGOING        ], // duration 5 hours
    [ACTION_TYPE.CONSTRUCT,     'Marketplace',      'Empty Lot',        1,      null,               null,   23 * HOUR,          false,  ACTION_STATE.ONGOING        ], // duration 23 hours
    [ACTION_TYPE.CONSTRUCT,     'Spaceport',        'Empty Lot',        2,      null,               null,   12 * HOUR,          false,  ACTION_STATE.ONGOING        ], // duration 12 hours
    // Done actions, defined in reverse b/c they are prepended, NOT appended
    [ACTION_TYPE.CONSTRUCT,     'Warehouse',        'Empty Lot',        777,    null,               null,   0,                  false,  ACTION_STATE.DONE,      96  ], // done 4 days ago
    [ACTION_TYPE.TRANSFER,      'Core Samplers',    'Light Transport',  666,    'Warehouse',        777,    0,                  false,  ACTION_STATE.DONE,      72  ], // done 3 days ago
    [ACTION_TYPE.CORE_SAMPLE,   'Water',            'Empty Lot',        89,     null,               null,   0,                  false,  ACTION_STATE.DONE,      48  ], // done 2 days ago
    [ACTION_TYPE.CONSTRUCT,     'Extractor',        'Empty Lot',        89,     null,               null,   0,                  false,  ACTION_STATE.DONE,      24  ], // done 1 day ago
    [ACTION_TYPE.CORE_SAMPLE,   'Hydrogen',         'Empty Lot',        123,    null,               null,   0,                  false,  ACTION_STATE.DONE,      18  ], // done 18 hours ago
];
